...
import {PriceDataNewZelandAndOthers} from './PricesData'
import './Prices.css'
import { gsap } from 'gsap'
import elkbg from "../Images/b&w-deer.jpg"


 function PricesNewZelandAndOther() {
  ...
  return (
    <div>
        <div>
            ...
            <div ref={naPrice}>
                {PriceDataNewZelandAndOthers.map((item, index)=>{
                    return(
...
export default PricesNewZelandAndOther